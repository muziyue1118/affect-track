...
class EEGRecorder: #127.0.0.1
    def __init__(self, n_chan=64, srate=250, host="127.0.0.1", port=8712, selected_ch=None, t_buffer=360):
        self.server = DataServerThread("Neuracle", n_chan+1, srate, t_buffer=t_buffer)
        self.host = host
        self.port = port
    ...
    def get_record(self, second):
        srate = self.srate
        frame = int(second*srate)
